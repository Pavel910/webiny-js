...
const { runAndWatch } = require("./runAndWatch");
...
module.exports = async inputs => {
    ...
    if (what === "api") {
        ...
        async function executeDeploy(alias = null) {
            const { output, duration } = await execute({ ...inputs, alias: alias || inputs.alias });
        ...
        return inputs.watch ? runAndWatch(executeDeploy, inputs) : executeDeploy();
    }
};
